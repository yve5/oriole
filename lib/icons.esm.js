...
const A = (s) => {
  ...
  return p ? n.push("svg-icon--md") : h && n.push("svg-icon--lg"), e ? n.push("svg-icon--danger") : m ? n.push("svg-icon--warning") : i ? n.push("svg-icon--disabled") : v ? n.push("svg-icon--primary") : d ? n.push("svg-icon--success") : u && n.push("svg-icon--info"), g && n.push("svg-icon--ghost"), f && n.push("svg-icon--help"), /* @__PURE__ */ l.createElement(
    "svg",
    {
      width: y,
      height: c,
