import t, { useState as i, useEffect as d } from "react";
import "clsx";
import { S as m } from "./SvgContainer-6CI3TG1p.js";
const E = (e) => /* @__PURE__ */ t.createElement(m, { ...e }, /* @__PURE__ */ t.createElement(
  "path",
  {
...
)), M = (e) => /* @__PURE__ */ t.createElement(m, { ...e }, /* @__PURE__ */ t.createElement(
  "path",
  {
...
)), Z = (e) => /* @__PURE__ */ t.createElement(m, { ...e }, /* @__PURE__ */ t.createElement(
  "path",
  {
...
)), h = "theme", l = ["light", "dark", "auto"], u = "(prefers-color-scheme: dark)", v = () => {
  const [e, n] = i(2), [s, T] = i(0);
  d(() => {
    const r = Number(sessionStorage.getItem(h));
    Number.isInteger(r) && n(r);
    const q = () => {
      T(window.matchMedia(u).matches ? 1 : 0);
    };
    q();
    const a = window.matchMedia(u), c = ["change", q];
  ...
  let o = /* @__PURE__ */ t.createElement(E, { medium: !0 });
  return e === 1 ? o = /* @__PURE__ */ t.createElement(Z, { medium: !0 }) : e === 2 && (o = /* @__PURE__ */ t.createElement(M, { medium: !0 })), /* @__PURE__ */ t.createElement(
    "button",
    {
      type: "button",
      title: l[e],
      ...
      onClick: () => {
        const r = (e + 1) % 3;
        sessionStorage.setItem(h, r), n(r);
      }
    },
    o
  );
