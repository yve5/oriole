...
const app = Vue.createApp({
  ...
  methods: {
    ...
    resetSelected() {
      this.cvssSelected = {};
      for ([metricType, metricTypeData] of Object.entries(
        this.cvssConfigData
      )) {
        for ([metricGroup, metricGroupData] of Object.entries(
